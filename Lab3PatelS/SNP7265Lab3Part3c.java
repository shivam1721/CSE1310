 ...
 * @author shivampatel
 */
public class SNP7265Lab3Part3c {
    ...
    public static void main(String[] args) {
        ...
        Scanner inputFile;
        File inFile = new File("SNP7265Lab3Part3c.txt");
        try
        {
        ...
        {
            System.out.println("Input File SNP7265Lab3Part3c.txt not found");  
