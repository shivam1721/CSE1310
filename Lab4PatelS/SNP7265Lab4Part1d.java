 ...
 * @author shivampatel
 */
public class SNP7265Lab4Part1d {
    ...
    public static void main(String[] args) {
        ...
        String fileName = "SNP7265Lab4Part1d";
        ...
        catch (FileNotFoundException fnfe)
        {
            ...
            System.out.println("Input File SNP7265Lab4Part1d.txt not found or output file not found ");  
    ...
    for (ri = 0; ri< robotIvalues.length; ri++)
        ...
        System.out.printf("%16s%6s%10s%13s%20s%39s%14s%11s   %7s%18s   %-40s\n","NAME","YEAR","COST","SOURCE","CATEGORY","TITLE","HEIGHT","WEIGHT","IMPLEMENTED","ACTOR","DOUBLE");
        outFile.printf("%16s%6s%10s%13s%20s%39s%14s%11s   %7s%18s   %-40s\n","NAME","YEAR","COST","SOURCE","CATEGORY","TITLE","HEIGHT","WEIGHT","IMPLEMENTED","ACTOR","DOUBLE");
        ...
        for (int ri = 0; ri < robotIvalues.length; ri++)
            if (robotIvalues[ri][0] != 0)
            {
                ...
                System.out.printf("%16s%6d%10s%10c%23s%40s%12.1f%12.1f     %4c%23s   %-40.1f\n",
                        robotSvalues[ri][0],robotIvalues[ri][0],robotSvalues[ri][3],robotCvalues[ri][0],robotSvalues[ri][1],robotSvalues[ri][2],robotDvalue[ri][1],robotDvalue[ri][2],robotCvalues[ri][1],robotSvalues[ri][4],robotDvalue[ri][3]);
