...
public class SNP7265Lab4Part2 {
    ...
    final int MAXROBOTS = 30;
        ...
        String fileName = "SNP7265Lab4Part2";
        ...
        catch (FileNotFoundException fnfe)
        {
            ...
            System.out.println("Input File SNP7265Lab4Part2.txt not found or output file not found ");  
    ...
    robotNTable(robotSvalues,robotIvalues,robotCvalues,outFile,robotDvalue);
        ...
        bubbleASort(robotSvalues,robotIvalues,robotDvalue,robotCvalues,outFile,sortBy);
    for (int i = 0; i< robotIvalues.length; i++)
        if(robotIvalues[i][0] != 0)
        {
    ...
    public static void bubbleASort(String[][] robotSvalues , int[][] robotIvalues, double[][] robotDvalue, char[][] robotCvalues, PrintWriter outFile, int sortBy)
    {
         int[] tmp; 
